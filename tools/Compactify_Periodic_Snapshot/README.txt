...
This was the old IC generator for compactified cosmological simulations.
- written in C++
- read Gadget2 and ascii IC formats
- output in ascii format
- Able to calculate spherical cosmological initial conditions using stereographic projection from the input periodic snapshot
...
Once you compiled the code, you can simply run it by typing:
	./Compactify_Periodic_Snapshot <parameterfile>
