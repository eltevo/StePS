...
#ifdef PERIODIC_Z
//TODO: Implement the forces_periodic_z function (everything below is fully periodic placeholder)
void forces_periodic_z(REAL*x, REAL*F, int ID_min, int ID_max) //force calculation with multiple images only in the z direction
{
//timing
double omp_start_time = omp_get_wtime();
//timing
